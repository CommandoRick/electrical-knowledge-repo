% 4. Introduction/background (<300 words, ~½ page): define the problem to be addressed,
% the goals (esp. specific deliverables) priorities and scope of the project. An analysis of the
% strategic importance (e.g., non‐financial criteria) of the project to the organisation, project
% stakeholders, current market and any alternative solutions and/or competitive
% products/technologies already, or soon to be, available;
% to combat the issue of asset losses
